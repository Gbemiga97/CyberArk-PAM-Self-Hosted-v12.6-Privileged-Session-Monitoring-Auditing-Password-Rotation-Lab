...
> 📌 **How to use this doc:** This is written as a project template/lab guide. Follow each numbered section in your own lab, then replace the `img/` placeholders below with your own screenshots as you complete each step. The folder structure suggested at the bottom mirrors how to publish this to GitHub when you're done.
